...
if(!class_exists('gsc_gmap')):
   class gsc_gmap{
      ...
      <script src="<?php print  $base_url . '/' . drupal_get_path('theme', 'gavias_financial') ?>/vendor/jquery.ui.map.min.js"></script>
      <script src="http://maps.google.com/maps/api/js?key=AIzaSyDWg9eU2MO9E0PF1ZMw9sFVJoPVU4Z6s3o"></script>
      <div id="map_canvas_<?php echo $_id; ?>" class="map_canvas" style="width:100%; height:<?php echo $height; ?>;"></div>
         ...
         <script type="text/javascript">
            jQuery(document).ready(function($) {
               ...
               var content = '<?php print gavias_render_textlangs($content) ?>';
