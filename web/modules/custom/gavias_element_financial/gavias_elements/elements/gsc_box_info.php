      ...
      public static function sc_box_info( $attr, $content = null ){
         ...
         ?>
            ...
            <div class="widget gsc-box-info <?php print $el_class ?>">
               <?php if($title){?><div class="title"><?php print gavias_render_textlangs($title) ?></div> <?php } ?>
               <?php if($address){?><div class="address"><?php print gavias_render_textlangs($address) ?></div> <?php } ?>
               <?php if($email){?><div class="email"><?php print $email ?></div> <?php } ?>
               <?php if($phone){?><div class="phone"><?php print $phone ?></div> <?php } ?>
               <?php if($content){?><div class="address"><?php print gavias_render_textlangs($content) ?></div> <?php } ?>
           </div>
